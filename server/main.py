...
from server.routes.dataset    import router as dataset_router
...
app = FastAPI(
    ...
    description="Automated analytics, ML predictions, and AI-powered insights",
    version="2.1.0",
)
...
@app.get("/")
def home():
    return {"message": "AI Data Intelligence Platform API v2.1"}
